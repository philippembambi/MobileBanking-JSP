...
public class TransfertServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
             ...
             String compteBeneficiare = request.getParameter("compteBeneficiare");
             
              
                   compte = new CompteController();
                   boolean registerResult = compte.makeTransfert(Float.valueOf(amount), compteBeneficiare);

                       action = "index";
                       request.getSession().setAttribute("action", action);
                       request.getSession().removeAttribute("transac");
                       
                       request.getSession().setAttribute("transac", "Vous venez d'effectuer un Transfert d'argent avec succès !");
